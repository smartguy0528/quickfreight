                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap hero-cap2 text-center pt-70">
                            ...
                            <h4 class="text-white pt-5">Quick Freight Enterprise Inc.</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="about-caption">
                        ...
                        <h1>Terms of Use</h1>
                        <p class="pera-top">Please read these terms and conditions carefully before using Our Service.</p>

                        <h1 class="pt-30">I. Interpretation and Definitions</h1>

                        <h2 class="pt-20">Interpretation</h2>
                        <p class="pera-top">
                            The words of which the initial letter is capitalized have meanings defined under the following conditions.
                            The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                        </p>

                        <h2 class="pt-20">Definitions</h2>
                        <p class="pera-top">For the purposes of these Terms and Conditions:</p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <p>
                                    ...
                                    Quick Freight Enterprise INC., 15867 SW 147th LN, Miami, FL 33196.
                                </p>
                            </li>
                            <li>
                                <p>
                            ...
                            <li>
                                <p><strong>Service</strong> refers to the transportation service provided by this Company.</p>
                            </li>
                            <li>
                                <p>
                            ...
                            <li>
                                <p>
                                    <strong>Website</strong> refers to Quick Freight Enterprise, accessible from
                                    <strong>https://quickfreightenterprise.com</strong>
                                </p>
                            </li>
                            <li>
                                <p>
                        ...
                        <h1 class="pt-50">II. Acknowledgment</h1>
                        <p class="pera-bottom">
                        ...
                        <p class="pera-bottom">
                            ...
                            Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
                            personal information
                            when You use the Application or the Website and tells You about Your privacy rights and how the law protects You.
                        </p>
                        <p class="pera-bottom">
                            Please read Our <a href="#privacy" class="text-primary">Privacy Policy</a> carefully before using Our Service.
                        </p>

                        <h1 class="pt-50">III. Links to Other Websites</h1>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50">IV. Termination</h1>
                        <p class="pera-bottom">
                        ...
                        <p class="pera-bottom">Upon termination, Your right to use the Service will cease immediately.</p>

                        <h1 class="pt-50">V. Limitation of Liability</h1>
                        <p class="pera-bottom">
                        ...
                        <p class="pera-bottom">
                            ...
                            third-party hardware used with the Service, or otherwise in connection with any provision of this Terms),
                        ...
                        <h1 class="pt-50">V. &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
                        <p class="pera-bottom">
                            ...
                            of any kind that the Service will meet Your requirements, achieve any intended results, be compatible or work with
                        ...
                        <p class="pera-bottom">
                            ...
                            content, and materials or products included thereon; (ii) that the Service will be uninterrupted or error-free;
                            (iii) as to the accuracy, reliability, or currency of any information or content provided through the Service;
                            or (iv) that the Service, its servers, the content, or e-mails sent from or on behalf of the Company are free
                        ...
                        <h1 class="pt-50">VI. Governing Law</h1>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50">VII. Disputes Resolution</h1>
                        <p class="pera-bottom">
                            If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally
                            by contacting the Company.
                        </p>

                        <h1 class="pt-50">VIII. For European Union (EU) Users</h1>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50">IIX. United States Legal Compliance</h1>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50">IX. Severability and Waiver</h1>
                        <h2 class="pt-30">Severability</h2>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50"> X. Translation Interpretation</h1>
                        <p class="pera-bottom">
                            These Terms and Conditions may have been translated if We have made them available to You on our Service.
                            You agree that the original English text shall prevail in the case of a dispute.
                        </p>

                        <h1 class="pt-50">XI. Changes to These Terms and Conditions</h1>
                        <p class="pera-bottom">
                            We reserve the right, at Our sole discretion, to modify or replace these Terms at any time.
                            If a revision is material We will make reasonable efforts to provide at least 30 days' notice prior to any
                        ...
                        <h1 class="pt-50">XII. Contact Us</h1>
                        <p class="pera-bottom">If you have any questions about these Terms and Conditions, You can contact us:</p>
                        <ul>
                            <li>
                                <p>By email: quickfreightenterprise@gmail.com</p>
                            </li>
                            <li>
                                <p>By phone number: +1 786-208-9900</p>
                            </li>
                        </ul>
                        <p class="pt-30 pera-bottom">Last updated: April 05, 2023</p>

                        <!-- Section Tittle -->
                        <p id="privacy"></p>
                        <div class="section-tittle section-tittle3 mt-200 mb-35">
                        ...
                        <h1 class="pt-50">I. Interpretation and Definitions</h1>
                        <h2 class="pt-30">Interpretation</h2>
                        <p class="pera-bottom">
                            The words of which the initial letter is capitalized have meanings defined under the following conditions.
                            The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                        </p>
                        <h2 class="pt-30">Definitions</h2>
                        <p class="pera-bottom">For the purposes of this Privacy Policy:</p>
                        <ul>
                            <li>
                                <p>
                            ...
                            <li>
                                <p>
                                    ...
                                    &quot;Our&quot; in this Agreement) refers to Quick Freight Enterprise INC., 15867 SW 147th LN, Miami, FL 33196.
                                </p>
                            </li>
                            <li>
                                <p>
                        ...
                        <h1 class="pt-50">II. Collecting and Using Your Personal Data</h1>
                        <h2 class="pt-30">1. Types of Data Collected</h2>
                        <h3 class="pt-30">Personal Data</h3>
                        <p class="pera-bottom">
                        ...
                        <h3 class="pt-10">Usage Data</h3>
                        <p class="pera-bottom">Usage Data is collected automatically when using the Service.</p>
                        <p class="pera-bottom">
                        ...
                        <h3 class="pt-10">Tracking Technologies and Cookies</h3>
                        <p class="pera-bottom">
                        ...
                        <ul>
                            ...
                            <li>
                                <p>
                                    ...
                                    the Company, for example, to count users who have visited those pages or opened an email and for other related
                                    website statistics (for example, recording the popularity of a certain section and verifying system and server
                                    integrity).
                                </p>
                            </li>
                        </ul>
                        <p class="pt-30 pera-bottom">
                            Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal
                            computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser.
                        </p>
                        <p class="pera-bottom">We use both Session and Persistent Cookies for the purposes set out below:</p>
                        <ul>
                            <li>
                        ...
                        <h2 class="pt-30">2. Use of Your Personal Data</h2>
                        <p class="pera-bottom">The Company may use Personal Data for the following purposes:</p>
                        <ul>
                            <li>
                                <p>
                        ...
                        <p class="pera-bottom">We may share Your personal information in the following situations:</p>
                        <ul>
                            <li>
                                <p>
                        ...
                        <h2 class="pt-30">3. Retention of Your Personal Data</h2>
                        <p class="pera-bottom">
                        ...
                        <h2 class="pt-30">4. Transfer of Your Personal Data</h2>
                        <p class="pera-bottom">
                        ...
                        <h2 class="pt-30">5. Delete Your Personal Data</h2>
                        <p class="pera-bottom">
                        ...
                        <h2 class="pt-30">6. Disclosure of Your Personal Data</h2>
                        <h3 class="pt-20">Business Transactions</h3>
                        <p class="pera-bottom">
                        ...
                        <h3 class="pt-20">Law enforcement</h3>
                        <p class="pera-bottom">
                        ...
                        <h3 class="pt-20">Other legal requirements</h3>
                        <p class="pera-bottom">
                        ...
                        <h2 class="pt-30">7. Security of Your Personal Data</h2>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50">III. Children's Privacy</h1>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50">IV. Links to Other Websites</h1>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50">V. Changes to this Privacy Policy</h1>
                        <p class="pera-bottom">
                        ...
                        <h1 class="pt-50">VI. Contact Us</h1>
                        <p class="pera-bottom">If you have any questions about this Privacy Policy, You can contact us:</p>
                        <ul>
                            <li>
                                <p>By email: quickfreightenterprise@gmail.com</p>
                            </li>
                        ...
                        <p class="pt-50 pera-bottom">Last updated: April 05, 2023</p>
