...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Requested Quotes</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Requested Quotes</li>
        </ol>
        <div class="card mb-4">
                ...
                <table id="quoteTable" class="table-centered display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$quote->name}}</td>
                            <td><a href="{{route('carrier.quote.details', $quote->id)}}" class="btn btn-success btn-sm"><i class="fas fa-clipboard-check"></i> Check Details</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
@push('scripts')
    ...
    <script src="{{asset('assets/backend/js/carrier/quotes.js')}}"></script>
@endpush