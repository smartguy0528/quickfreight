            ...
            columns: [
                ...
                { data: 'phone' },
                {
                    "render": function (data, type, full, meta) {
                        let btnDetails = `<button class="btn btn-info w-125p btn-sm" onclick="fn.detailQuote(` + full.id + `)"><i class="fas fa-check-square"></i> Check Details</button>
                                        <a href="/manager/quote/details/`+ full.id +`" class="btn btn-success w-125p btn-sm"><i class="fas fa-truck"></i> Select Carrier</a>`;
                        return btnDetails;
                    }
                }
            ],
